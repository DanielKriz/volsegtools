...
from volsegtools.model import (ChannelMetadata, OpaqueDataHandle,
                               OriginalTimeFrameMetadata, TimeFrameMetadata)
    ...
    async def serialize(data: OpaqueDataHandle, output_path: Path) -> None:
        # This is currently working only for volumes!
            for channel in data.metadata.channels:
                ...
                metadata_file_name = Path("{}_r{}_tf{}_metadata.json".format(
